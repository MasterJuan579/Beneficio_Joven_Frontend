...
function GestionDuenos() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Establecimientos</th>
                  ...
                  {filteredDuenos.map((dueno) => (
                    <tr key={dueno.idDueno} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{dueno.nombreUsuario}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500">{dueno.email}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500">{dueno.cantidadEstablecimientos || 0}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center gap-3">
                          ...
                          <ToggleSwitch isActive={dueno.activo} onToggle={() => handleToggleClick(dueno)} />
                        </div>
                      </td>
                    </tr>
                  ))}
      ...
      {/* Modales */}
      <AddDuenoModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onDuenoCreated={fetchDuenos} />
      <ConfirmToggleModal
