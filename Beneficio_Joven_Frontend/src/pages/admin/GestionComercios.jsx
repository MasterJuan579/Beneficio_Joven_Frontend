...
function GestionComercios() {
  ...
  const handleExportCSV = () => {
    ...
    const dataToExport = sucursales.map(sucursal => ({
      ...
      'Fecha Registro': new Date(sucursal.fechaRegistro).toLocaleDateString('es-MX')
    }));
                    ...
                    <tr key={sucursal.idSucursal} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center gap-3">
                          ...
                          <button className={sucursal.activo ? 'text-red-600 hover:text-red-900' : 'text-green-600 hover:text-green-900'}>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
